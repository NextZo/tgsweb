            ...
            <div class="flex shadow-lg rounded-lg p-6">
                ...
                <div class="relative w-full py-4">
                    ...
                    <div class="absolute right-0 top-0 bottom-0 flex flex-col justify-center px-6 py-10 gap-3">
                        @if ($hoodie->s)
                            <button onclick="size('s-{{ $hoodie->id }}')"
                        ...
                        @if ($hoodie->m)
                            <button onclick="size('m-{{ $hoodie->id }}')"
                        ...
                        @if ($hoodie->l)
                            <button onclick="size('l-{{ $hoodie->id }}')"
                        ...
                        @if ($hoodie->xl)
                            <button onclick="size('xl-{{ $hoodie->id }}')"
                    ...
                    <button onclick="addToKeranjang({{ $hoodie->id }})"
